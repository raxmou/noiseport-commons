    ...
    <>
      ...
      <section id="mobile-install">
        <p>
          ...
          an pour publier une application sur l'App Store, ce qui n'est pas
          viable pour un projet open-source et gratuit.
        </p>
        <br />
        <div className="bg-neutral-900/80 rounded-lg p-3 md:p-4 mb-4 md:mb-6 text-xs md:text-sm text-neutral-200 border border-primary">
          ...
          l'application desktop, et j'utilise principalement la version desktop
          au quotidien. J'ai donc consacré moins d'efforts de développement à
          ...
          <br />
          <b>Remerciements&nbsp;:</b> Un grand merci aux développeur·euse·s
          actif·ve·s de Finamp pour leur travail et leur engagement open-source.
        </div>
      </section>
