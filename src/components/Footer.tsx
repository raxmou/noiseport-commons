export default function Footer() {
  return (
    <footer className="relative z-50 w-full bg-black border-t border-neutral-800 px-4 md:px-8 py-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-center md:text-left text-xs font-syne text-neutral-400">
          ...
          <div>
            Typo <span className="font-kode">Kode Mono</span> &{" "}
            <span className="font-syne">Syne</span>
          </div>
        </div>
